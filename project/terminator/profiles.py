...
# Changed generic list view function to use class
...
# Ditched utils.py from profiles, use direct references to user profile model. Reproduce form get here.
from terminator.models import UserProfile
from django import forms
# For the extra context
from terminator.forms import SearchForm
...
# Added in order to have extra context
...
def profile_list(request, public_profile_field=None,
    ...
    **Template:**
    ...
    #kwargs['context_object_name'] = kwargs['template_object_name']
    kwargs['context_object_name'] = 'profile_list'
    kwargs['template_name'] = template_name
    del kwargs['template_object_name']
    del kwargs['extra_context']
    # Change to class-based view. Use custom one to have extra context.
    callable = ProfileListView.as_view(**kwargs)
